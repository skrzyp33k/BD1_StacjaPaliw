  ...
  <main class="container">
    ...
    <div class="container">
      <?php
        ...
        if($conn)
        {
          $query = mysqli_query($conn, "SELECT * FROM Paliwa;");
          $result = mysqli_fetch_all($query, MYSQLI_ASSOC);
          echo '<table class="result_table">';
          echo '<tr>';
          echo '<th>Nazwa</th><th>Cena za litr</th><th>Rodzaj</th><th>Opis</th><th>% Vat</th><th>Akcje</th>';
          echo '</tr>';
          foreach($result as $row)
          {
            ...
            <form method="POST" action="./edit_fuel.php" >
            ...
            <td style="border: 1px solid black;">
            <form method="POST" action="./delete_fuel.php" >
            <input type="hidden" name="fuel_id" value="$fuel_id"/>
    ...
    <h1>Dodaj paliwo</h1>
    <div class="container">
    <form method="POST" action="insert_fuel.php">
            <div class="form-group">
                <label for="nameInput">Nazwa</label>
                <input type="text" class="form-control" id="nameInput" name="nameInput" value="" maxlength="20"/>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="typeInput" name="typeInput" value="" maxlength="15"/>
            </div>
            <div class="form-group">
