<?php
    ...
    $query_service = mysqli_query($conn, "SELECT * FROM Uslugi WHERE ID_uslugi = ".$_POST['service_id'].";");

    $result_service = mysqli_fetch_all($query_service, MYSQLI_ASSOC);
    ...
    <div class="container">
      ...
      <a href="../" style="height: 64px;"><img src="../img/gbs.png" class="img-fluid" style="height: 64px;"/></a>
        ...
        <li><a href="../index.php" class="nav-link px-2 text-white">Strona główna</a></li>
          ...
          <li><a href="./uslugi.php" class="nav-link px-2 text-black">Usługi</a></li>
    ...
    <div class="container">
      <form method="POST" action="update_service.php">
        <div class="form-group">
          ...
          <input type="text" class="form-control" id="nameInput" name="nameInput" value="<?php echo $result_service[0]['nazwa']; ?>" maxlength="30"/>
        </div>
        <div class="form-group">
          <label for="priceInput">Cena</label>
          <input type="text" onkeypress="return onlyNumberKey(event)" class="form-control" id="priceInput" name="priceInput" value="<?php echo $result_service[0]['cena']; ?>" maxlength="5"/>
        </div>
        <div class="form-group">
          <label for="descriptionInput">Opis</label>
          <input type="text" class="form-control" id="descriptionInput" name="descriptionInput" value="<?php echo $result_service[0]['opis']; ?>" maxlength="100"/>
        </div>
        <div class="form-group">
          <label for="taxInput">% Vat</label>
          <input type="text" onkeypress="return onlyNumberKey(event)" class="form-control" id="taxInput" name="taxInput" value="<?php echo $result_service[0]['vat']; ?>" maxlength="2"/>
        </div>
        <input type="hidden" name="serviceID" value="<?php echo $_POST['service_id']; ?>" />
