...
if($_POST['streetInput'] != "" && $_POST['buildingInput'] != "" && $_POST['postalInput'] != "" && $_POST['cityInput'] != "" && $_POST['countryInput'] != "" && $_POST['positionInput'] != "" && $_POST['salaryInput'] != "" && $_POST['nameInput'] != "" && $_POST['surnameInput'] != "" && $_POST['phoneInput'] != "" && $_POST['bankInput'] != "")
{
    ...
    $query = "INSERT INTO Pracownicy(stanowisko, wyplata, imie, nazwisko, telefon, nr_rachunku, ID_adresu) VALUES ('".$_POST['positionInput']."', ".$_POST['salaryInput'].", '".$_POST['nameInput']."','".$_POST['surnameInput']."','".$_POST['phoneInput']."','".$_POST['bankInput']."',".$id_addr.");";
